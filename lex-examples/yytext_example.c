...
static yyconst flex_uint16_t yy_base[14] =
    {   0,
        0,    0,   10,   11,    4,    0,   11,   11,    0,    0,
       11,   11,   11
    } ;

static yyconst flex_int16_t yy_def[14] =
    {   0,
       13,    1,   13,   13,   13,    5,   13,   13,    5,    5,
       13,   13,    0
    } ;
...
char *yytext;
#line 1 "yytex_example.l"
#line 3 "yytex_example.l"
	#include <stdlib.h>
	#include <stdio.h>
#line 476 "lex.yy.c"
...
case 1:
YY_RULE_SETUP
#line 12 "yytex_example.l"
{printf("Found odd : %d\n",atoi(yytext));}
	YY_BREAK
case 2:
YY_RULE_SETUP
#line 13 "yytex_example.l"
{printf("Found even : %d\n",atoi(yytext));}
	YY_BREAK
case 3:
YY_RULE_SETUP
#line 15 "yytex_example.l"
ECHO;
	YY_BREAK
#line 769 "lex.yy.c"
